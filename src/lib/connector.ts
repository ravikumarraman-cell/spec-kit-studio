...
export interface TruthReport {
  ...
  packageScripts: Record<string, string>; baselineCommands: { id: string; label: string; runner: 'npm'; script: string; workingDirectory: string }[]; agents: LocalAgentStatus[]; git: { available: boolean; branch: string | null; status: string; remotes: string }; specKit: { detected: boolean; featureFile: boolean };
}
